...
class NiveauEtudeResourceIT {
    ...
    private static final LocalDate DEFAULT_ANNEE_ETUDE = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_ANNEE_ETUDE = LocalDate.now(ZoneId.systemDefault());
    ...
    public static NiveauEtude createEntity(EntityManager em) {
        NiveauEtude niveauEtude = new NiveauEtude().niveau(DEFAULT_NIVEAU).anneeEtude(DEFAULT_ANNEE_ETUDE);
        return niveauEtude;
    }
    ...
    public static NiveauEtude createUpdatedEntity(EntityManager em) {
        NiveauEtude niveauEtude = new NiveauEtude().niveau(UPDATED_NIVEAU).anneeEtude(UPDATED_ANNEE_ETUDE);
        return niveauEtude;
    }
    ...
    void createNiveauEtude() throws Exception {
        ...
        assertThat(testNiveauEtude.getAnneeEtude()).isEqualTo(DEFAULT_ANNEE_ETUDE);
    }
    ...
    void putNewNiveauEtude() throws Exception {
        ...
        updatedNiveauEtude.niveau(UPDATED_NIVEAU).anneeEtude(UPDATED_ANNEE_ETUDE);
        ...
        assertThat(testNiveauEtude.getAnneeEtude()).isEqualTo(UPDATED_ANNEE_ETUDE);
    }
    ...
    void fullUpdateNiveauEtudeWithPatch() throws Exception {
        ...
        partialUpdatedNiveauEtude.niveau(UPDATED_NIVEAU).anneeEtude(UPDATED_ANNEE_ETUDE);
    ...
    void deleteNiveauEtude() throws Exception {
        ...
        restNiveauEtudeMockMvc
            .perform(delete(ENTITY_API_URL_ID, niveauEtude.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
