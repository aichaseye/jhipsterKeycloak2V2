...
describe('EtatDemande Management Component', () => {
  let comp: EtatDemandeComponent;
  let fixture: ComponentFixture<EtatDemandeComponent>;
  let service: EtatDemandeService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'etat-demande', component: EtatDemandeComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(EtatDemandeComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.etatDemandes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
