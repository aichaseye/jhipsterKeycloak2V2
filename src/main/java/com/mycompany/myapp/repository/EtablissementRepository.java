...
public interface EtablissementRepository extends JpaRepository<Etablissement, Long> {
    ...
    @Query(
        value = "select distinct etablissement from Etablissement etablissement left join fetch etablissement.demandeMatriculeEtab",
    ...
    @Query("select distinct etablissement from Etablissement etablissement left join fetch etablissement.demandeMatriculeEtab")
    List<Etablissement> findAllWithToOneRelationships();

    @Query(
        "select etablissement from Etablissement etablissement left join fetch etablissement.demandeMatriculeEtab where etablissement.id =:id"
    )
