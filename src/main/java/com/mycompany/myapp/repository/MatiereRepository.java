...
public interface MatiereRepository extends JpaRepository<Matiere, Long> {
    ...
    @Query(
        value = "select distinct matiere from Matiere matiere left join fetch matiere.etablissement",
    ...
    @Query("select distinct matiere from Matiere matiere left join fetch matiere.etablissement")
    List<Matiere> findAllWithToOneRelationships();

    @Query("select matiere from Matiere matiere left join fetch matiere.etablissement where matiere.id =:id")
