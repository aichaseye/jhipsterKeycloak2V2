...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.NiveauEtude}.
 */
@RestController
@RequestMapping("/api")
public class NiveauEtudeResource {
    ...
    public ResponseEntity<NiveauEtude> updateNiveauEtude(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, niveauEtude.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<NiveauEtude> partialUpdateNiveauEtude(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, niveauEtude.getId().toString())
        );
    }
