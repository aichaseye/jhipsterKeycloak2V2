...
import com.mycompany.myapp.repository.FiliereEtudeRepository;
import com.mycompany.myapp.service.FiliereEtudeService;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.FiliereEtude}.
 */
@RestController
@RequestMapping("/api")
public class FiliereEtudeResource {
    ...
    public ResponseEntity<FiliereEtude> createFiliereEtude(@RequestBody FiliereEtude filiereEtude) throws URISyntaxException {
    ...
    public ResponseEntity<FiliereEtude> updateFiliereEtude(
        ...
        @RequestBody FiliereEtude filiereEtude
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, filiereEtude.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<FiliereEtude> partialUpdateFiliereEtude(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, filiereEtude.getId().toString())
        );
    }
