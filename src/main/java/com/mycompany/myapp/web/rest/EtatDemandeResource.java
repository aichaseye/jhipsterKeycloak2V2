...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.EtatDemande}.
 */
@RestController
@RequestMapping("/api")
public class EtatDemandeResource {
    ...
    public ResponseEntity<EtatDemande> updateEtatDemande(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, etatDemande.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<EtatDemande> partialUpdateEtatDemande(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, etatDemande.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<EtatDemande>> getAllEtatDemandes(
        @org.springdoc.api.annotations.ParameterObject Pageable pageable,
        @RequestParam(required = false, defaultValue = "true") boolean eagerload
    ) {
        log.debug("REST request to get a page of EtatDemandes");
        Page<EtatDemande> page;
        if (eagerload) {
            page = etatDemandeService.findAllWithEagerRelationships(pageable);
        } else {
            page = etatDemandeService.findAll(pageable);
        }
