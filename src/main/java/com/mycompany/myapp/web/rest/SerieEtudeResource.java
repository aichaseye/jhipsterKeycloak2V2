...
import com.mycompany.myapp.domain.SerieEtude;
import com.mycompany.myapp.repository.SerieEtudeRepository;
import com.mycompany.myapp.service.SerieEtudeService;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.SerieEtude}.
 */
@RestController
@RequestMapping("/api")
public class SerieEtudeResource {
    ...
    public ResponseEntity<SerieEtude> createSerieEtude(@RequestBody SerieEtude serieEtude) throws URISyntaxException {
    ...
    public ResponseEntity<SerieEtude> updateSerieEtude(
        ...
        @RequestBody SerieEtude serieEtude
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, serieEtude.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<SerieEtude> partialUpdateSerieEtude(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, serieEtude.getId().toString())
        );
    }
